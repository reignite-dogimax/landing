...
function initI18n() {
    const translations = {
        en: {
            ...
            "about.mission.description": "Our team of developers, veterinarians, and animal behavior experts works tirelessly to create tools that strengthen the bond between people and their dogs, while ensuring the best possible care. We believe that technology should serve to enhance the relationship between humans and their pets, making every interaction more meaningful and every moment together more valuable.",
            ...
            "about.videos.title": "Learn More About Us",
            "about.videos.subtitle": "Discover our team and product through these informative videos",
            "about.videos.team.title": "About The Team",
            "about.videos.team.description": "Meet the passionate professionals behind Dogimax. Learn about our diverse team of software engineers, veterinarians, and animal care experts who are dedicated to revolutionizing dog care through innovative technology.",
            "about.videos.team.button": "Watch Video",
            "about.videos.product.title": "About The Product",
            "about.videos.product.description": "Explore Dogimax in detail. Discover how our app combines artificial intelligence, smart scheduling, and comprehensive health management to provide the best care for your beloved dog.",
            "about.videos.product.button": "Watch Video",
            ...
            "terms.hero.subtitle": "Please read these terms carefully before using Dogimax. By using our service, you agree to be bound by these terms.",
            "terms.hero.lastUpdated": "Last updated: January 2025",
            "terms.section1.title": "1. Acceptance of Terms",
            "terms.section1.content": "By accessing and using Dogimax, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.",
            "terms.section2.title": "2. Use License",
            "terms.section2.content": "Permission is granted to temporarily use Dogimax for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:",
            "terms.section2.list": "Modify or copy the materials|Use the materials for any commercial purpose or for any public display|Attempt to reverse engineer any software contained in Dogimax|Remove any copyright or other proprietary notations from the materials|Transfer the materials to another person or \"mirror\" the materials on any other server",
            "terms.section3.title": "3. User Account",
            "terms.section3.content": "When you create an account with us, you must provide information that is accurate, complete, and current at all times. You are responsible for safeguarding the password and for all activities that occur under your account.",
            "terms.section4.title": "4. Service Availability",
            "terms.section4.content": "We reserve the right to withdraw or amend our service, and any service or material we provide, in our sole discretion without notice. We will not be liable if, for any reason, all or any part of our service is unavailable at any time or for any period.",
            "terms.section5.title": "5. Premium Subscription",
            "terms.section5.content": "Dogimax offers both free and premium subscription plans. Premium subscriptions are billed on a monthly or annual basis. You may cancel your subscription at any time, and cancellation will take effect at the end of the current billing period.",
            "terms.section6.title": "6. Prohibited Uses",
            "terms.section6.content": "You may use Dogimax only for lawful purposes and in accordance with these Terms. You agree not to use the service:",
            "terms.section6.list": "In any way that violates any applicable law or regulation|To transmit any malicious code or harmful software|To impersonate or attempt to impersonate the company or another user|In any manner that could disable, overburden, damage, or impair the service",
            "terms.section7.title": "7. Intellectual Property Rights",
            "terms.section7.content": "The service and its original content, features, and functionality are and will remain the exclusive property of Dogimax and its licensors. The service is protected by copyright, trademark, and other laws.",
            "terms.section8.title": "8. Disclaimer",
            "terms.section8.content": "The information on Dogimax is provided on an \"as is\" basis. To the fullest extent permitted by law, Dogimax excludes all representations, warranties, and conditions relating to our service and the use of this service.",
            "terms.section8.medical": "Important: Dogimax is not a substitute for professional veterinary care. Always consult with a licensed veterinarian for medical advice, diagnosis, or treatment of your pet.",
            "terms.section9.title": "9. Limitation of Liability",
            "terms.section9.content": "In no event shall Dogimax, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.",
            "terms.section10.title": "10. Indemnification",
            "terms.section10.content": "You agree to defend, indemnify, and hold harmless Dogimax and its licensee and licensors, and their employees, contractors, agents, officers and directors, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses.",
            "terms.section11.title": "11. Termination",
            "terms.section11.content": "We may terminate or suspend your account and bar access to the service immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.",
            "terms.section12.title": "12. Changes to Terms",
            "terms.section12.content": "We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days notice prior to any new terms taking effect.",
            "terms.section13.title": "13. Contact Information",
            "terms.section13.content": "If you have any questions about these Terms and Conditions, please contact us through our support channels or visit our website."
        },
        es: {
            ...
            "about.mission.description": "Nuestro equipo de desarrolladores, veterinarios y expertos en comportamiento animal trabaja incansablemente para crear herramientas que fortalezcan el vínculo entre las personas y sus perros, mientras garantizan el mejor cuidado posible. Creemos que la tecnología debe servir para mejorar la relación entre los humanos y sus mascotas, haciendo que cada interacción sea más significativa y cada momento juntos sea más valioso.",
            ...
            "about.videos.title": "Conoce Más Sobre Nosotros",
            "about.videos.subtitle": "Descubre nuestro equipo y producto a través de estos videos informativos",
            "about.videos.team.title": "Sobre El Equipo",
            "about.videos.team.description": "Conoce a los profesionales apasionados detrás de Dogimax. Aprende sobre nuestro diverso equipo de ingenieros de software, veterinarios y expertos en cuidado animal que están dedicados a revolucionar el cuidado canino a través de tecnología innovadora.",
            "about.videos.team.button": "Ver Video",
            "about.videos.product.title": "Sobre El Producto",
            "about.videos.product.description": "Explora Dogimax en detalle. Descubre cómo nuestra aplicación combina inteligencia artificial, programación inteligente y gestión integral de la salud para brindar el mejor cuidado a tu querido perro.",
            "about.videos.product.button": "Ver Video",
            ...
            "terms.hero.subtitle": "Por favor lea estos términos cuidadosamente antes de usar Dogimax. Al usar nuestro servicio, usted acepta estar sujeto a estos términos.",
            "terms.hero.lastUpdated": "Última actualización: Enero 2025",
            "terms.section1.title": "1. Aceptación de los Términos",
            "terms.section1.content": "Al acceder y usar Dogimax, usted acepta y se compromete a cumplir con los términos y disposiciones de este acuerdo. Si no está de acuerdo con lo anterior, por favor no use este servicio.",
            "terms.section2.title": "2. Licencia de Uso",
            "terms.section2.content": "Se otorga permiso para usar temporalmente Dogimax solo para visualización personal, no comercial y transitoria. Esta es la concesión de una licencia, no una transferencia de título, y bajo esta licencia no puede:",
            "terms.section2.list": "Modificar o copiar los materiales|Usar los materiales para cualquier propósito comercial o para cualquier exhibición pública|Intentar hacer ingeniería inversa de cualquier software contenido en Dogimax|Eliminar cualquier notación de derechos de autor u otra propiedad de los materiales|Transferir los materiales a otra persona o \"reflejar\" los materiales en cualquier otro servidor",
            "terms.section3.title": "3. Cuenta de Usuario",
            "terms.section3.content": "Cuando crea una cuenta con nosotros, debe proporcionar información que sea precisa, completa y actual en todo momento. Usted es responsable de proteger la contraseña y de todas las actividades que ocurran bajo su cuenta.",
            "terms.section4.title": "4. Disponibilidad del Servicio",
            "terms.section4.content": "Nos reservamos el derecho de retirar o modificar nuestro servicio, y cualquier servicio o material que proporcionemos, a nuestra sola discreción sin previo aviso. No seremos responsables si, por cualquier razón, todo o parte de nuestro servicio no está disponible en cualquier momento o por cualquier período.",
            "terms.section5.title": "5. Suscripción Premium",
            "terms.section5.content": "Dogimax ofrece planes de suscripción gratuitos y premium. Las suscripciones premium se facturan mensual o anualmente. Puede cancelar su suscripción en cualquier momento, y la cancelación tendrá efecto al final del período de facturación actual.",
            "terms.section6.title": "6. Usos Prohibidos",
            "terms.section6.content": "Puede usar Dogimax solo para fines legales y de acuerdo con estos Términos. Usted acepta no usar el servicio:",
            "terms.section6.list": "De cualquier manera que viole cualquier ley o regulación aplicable|Para transmitir cualquier código malicioso o software dañino|Para hacerse pasar o intentar hacerse pasar por la empresa u otro usuario|De cualquier manera que pueda deshabilitar, sobrecargar, dañar o perjudicar el servicio",
            "terms.section7.title": "7. Derechos de Propiedad Intelectual",
            "terms.section7.content": "El servicio y su contenido original, características y funcionalidad son y seguirán siendo propiedad exclusiva de Dogimax y sus licenciantes. El servicio está protegido por derechos de autor, marcas registradas y otras leyes.",
            "terms.section8.title": "8. Descargo de Responsabilidad",
            "terms.section8.content": "La información en Dogimax se proporciona \"tal cual\". En la medida máxima permitida por la ley, Dogimax excluye todas las representaciones, garantías y condiciones relacionadas con nuestro servicio y el uso de este servicio.",
            "terms.section8.medical": "Importante: Dogimax no es un sustituto de la atención veterinaria profesional. Siempre consulte con un veterinario licenciado para obtener asesoramiento médico, diagnóstico o tratamiento de su mascota.",
            "terms.section9.title": "9. Limitación de Responsabilidad",
            "terms.section9.content": "En ningún caso Dogimax, ni sus directores, empleados, socios, agentes, proveedores o afiliados, serán responsables de daños indirectos, incidentales, especiales, consecuentes o punitivos, incluidos, sin limitación, pérdida de ganancias, datos, uso, buena voluntad u otras pérdidas intangibles.",
            "terms.section10.title": "10. Indemnización",
            "terms.section10.content": "Usted acepta defender, indemnizar y eximir de responsabilidad a Dogimax y sus licenciantes, y sus empleados, contratistas, agentes, funcionarios y directores, de y contra cualquier y todas las reclamaciones, daños, obligaciones, pérdidas, responsabilidades, costos o deudas, y gastos.",
            "terms.section11.title": "11. Terminación",
            "terms.section11.content": "Podemos terminar o suspender su cuenta y prohibir el acceso al servicio de inmediato, sin previo aviso o responsabilidad, por cualquier motivo, incluido, sin limitación, si viola los Términos.",
            "terms.section12.title": "12. Cambios a los Términos",
            "terms.section12.content": "Nos reservamos el derecho, a nuestra sola discreción, de modificar o reemplazar estos Términos en cualquier momento. Si una revisión es material, proporcionaremos al menos 30 días de aviso antes de que cualquier nuevo término entre en vigor.",
            "terms.section13.title": "13. Información de Contacto",
            "terms.section13.content": "Si tiene alguna pregunta sobre estos Términos y Condiciones, por favor contáctenos a través de nuestros canales de soporte o visite nuestro sitio web."
        }
    };
    ...
    const setLanguage = (lang) => {
        ...
        document.querySelectorAll('[data-i18n]').forEach(element => {
            ...
            if (translation) {
                ...
                } else if (element.tagName === 'UL' && element.classList.contains('terms-list')) {
                    // Handle terms lists - split by | and create list items
